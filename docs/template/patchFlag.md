...
![full-progress](/template/patchFlag/full-progress.png){data-zoomable}
...
![or](/template/patchFlag/or.png){data-zoomable}
...
![vnodePatchFlag](/template/patchFlag/vnodePatchFlag.png){data-zoomable}
...
![codegenNode](/template/patchFlag/codegenNode.png){data-zoomable}
...
![network](/template/patchFlag/network.png){data-zoomable}
...
![sort](/template/patchFlag/sort.png){data-zoomable}
...
先来看看n1旧虚拟DOM ，如下图：
![n1](/template/patchFlag/n1.png){data-zoomable}

从上面可以看到此时的n1为根block节点，此时p标签中的文本还是更新前的文本"hello"，`dynamicChildren`属性为收集到的所有动态子节点。

接着来看n2新虚拟DOM，如下图：
![n2](/template/patchFlag/n2.png){data-zoomable}
...
![class](/template/patchFlag/class.png){data-zoomable}
...
![style](/template/patchFlag/style.png){data-zoomable}
...
![text](/template/patchFlag/text.png){data-zoomable}
